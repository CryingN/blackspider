...
def init():
    ...
    if ls_bool:
        ...
        if choose in choose_true:
            if ".git" in lost_file:
                print("重新获取源码:\n    github源:\033[36mhttps://github.com/CryingN/blackspider\033[0m\n    gitee源:\033[36mhttps://gitee.com/cryingn/blackspider\033[0m")
            try:
                os.system("git reset --hard HEAD")
            except:
                print(false+"请安装git插件")
            # 异步,再说,垃圾微软
    return ls
